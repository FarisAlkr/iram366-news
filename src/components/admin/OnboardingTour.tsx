...
const TOUR_STEPS: TourStep[] = [
  ...
  },
  {
    ...
    body: (
      <>
        <p>
          اضغط <strong>المقالات</strong> في القائمة الجانبية لرؤية كل قصصك. تستطيع البحث، التصفية،
          وفتح أي مقال للتحرير.
        </p>
        <p>
          عند الإنشاء، استخدم تبويب <strong>المحتوى</strong> للنص، <strong>الوسائط والتصنيف</strong>{' '}
          للصورة الرئيسية، و<strong>SEO</strong> لتحسين ظهور المقال في جوجل.
        </p>
      </>
    ),
  },
  {
    ...
    body: (
      <>
        ...
        <p>
          💡 لجدولة النشر لاحقاً، اختر تاريخاً مستقبلياً مع الحالة &ldquo;منشور&rdquo; — لن يظهر
          للقراء قبل ذلك الموعد.
        </p>
      </>
    ),
  },
  {
    ...
    body: (
      <>
        <p>
          أثناء كتابة مقال، ابحث عن زر <strong>Live Preview</strong> أعلى الصفحة. يفتح لوحة جانبية
          تُظهر شكل المقال على الموقع — للهاتف أو اللابتوب.
        </p>
        <p>
          ميدان الكتابة نفسه يبدو الآن كصفحة الموقع: نفس الخط، نفس المسافات، نفس النمط. ما تراه هو
          ما سيراه القارئ.
        </p>
      </>
    ),
  },
  {
    ...
    body: (
      <>
        <p>
          اضغط <kbd>⌘ K</kbd> (أو <kbd>Ctrl K</kbd>) من أي مكان لفتح البحث السريع — اكتب أي كلمة من
          العنوان وستقفز مباشرة للمقال.
        </p>
        <p>
