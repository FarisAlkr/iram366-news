...
export const SiteSettings: GlobalConfig = {
  ...
  fields: [
    ...
    },
    {
      name: 'socialHub',
      type: 'group',
      label: 'مركز التواصل الاجتماعي',
      admin: {
        description:
          'زر عائم في الزاوية السفلية اليسرى يفتح روابط الشبكات الاجتماعية المعرّفة في "روابط التواصل الاجتماعي" أعلاه. يوتيوب لا يظهر هنا — يبقى في قائمة روابط التذييل فقط.',
      },
      fields: [
        {
          name: 'enabled',
